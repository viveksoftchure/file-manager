...
?>
        ...
        <div id="modal" class="modal modal-overlay">
            <div class="modal-box">
                ...
                <div class="modal-body">
                    <div class="modal-notifications" style="display: none;"></div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary disabled" id="submit_btn" data-label="Save bookmark">Save bookmark</button>
                </div>
            </div>
        </div>
